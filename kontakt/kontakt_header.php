...
<head>
    ...
    <title>Conny Kerpl - Kontakt </title>
        ...
        <nav class="navbar mainmenu">
            ...
            <div class="navbar-collapse pull-right collapse" id="navbar-collapse">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="">
                        <a href="../ueber_mich" class="">ÜBER MICH</a>
                    </li>
                    <li class="">
                        <a href="../meine_arbeiten" class="">MEINE ARBEITEN</a>
                    </li>
                    <li class="">
                        <a href="../services" class="">KURSE & MEHR</a>
                    </li>
                    <li class="">
                        <a href="../neuigkeiten" class="">NEUIGKEITEN</a>
                    </li>
                    <li class="current-menu-item">
                        <a href="index.php" class="">KONTAKT</a>
                    </li>
                </ul>
            </div>
        </nav>
