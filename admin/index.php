...
$items_total_count = $projects->count_all("projects");
...
<div class="wrapper">
    ...
    <article class="container products">
            ...
            <div class="widget">
                ...
                <nav>
                    <ul class="category-list">
                        <li>
                            <a href="kategorie.php?kategorie=glasobjekten">Glasobjekten 
                        ...
                        <li>
                            <a href="kategorie.php?kategorie=flaschenuhren">Flaschenuhren 
                                <span class="pull-right">
                                    <?php
                        ...
                        <li>
                            <a href="kategorie.php?kategorie=schmuck">Schmuck 
                                <span class="pull-right">
                                    <?php
        ...
        <div class="col-md-9 col-xs-8 product-list m-center">
            ...
            <p class="alert-success text-center"> <?php if ($success_del) {
                                        echo $success_del;
                                    } ?> </p>

            <p class="alert-danger text-center"> <?php if ($error_del) {
                                        echo $error_del;
                                    } ?> </p>
                    ...
                    <div class="col-md-8 cdescription">
                        ...
                        <div class="row">
                            <div class="rating-wrap">
                                <a href="kategorie.php?kategorie=<?php echo $row['project_cat']; ?>" class="add-review black"><?php echo $row['project_cat']; ?></a>
                            </div>
                        </div>
                        <p><?php echo $row['project_desc']; ?></p>
                        <a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">löschen</a>
                        <a href="../einzelarbeit?p_id=<?php echo $row['id']; ?>" class="btn btn-default hidden-xs">anschauen</a>
                    </div>
                </div>
                <br>
<?php } ?>
                    ...
                    <ul class="pagination">
                        ...
                        if ($paginate->page_total() > 1) {
                            if ($paginate->has_prev()) {
                                echo "<li><a href='index.php?page={$paginate->previous()}' class='prev'></a></li>";
                            }
                            ...
                            if ($paginate->has_next()) {
                                echo "<li><a href='index.php?page={$paginate->next()}' class='next'></a></li>";
                            }
                        }
                        ?>
                    </ul>
